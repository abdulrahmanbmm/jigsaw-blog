    ...
    <ul class="my-0">
        <li class="pl-4">
            <a
                ...
                href="/index"
                class="block mt-0 mb-4 text-sm no-underline {{ $page->isActive('/index') ? 'active text-blue-500' : 'text-gray-800 hover:text-blue-500' }}"
            >Home</a>
        </li>
        <li class="pl-4">
            <a
        ...
        <li class="pl-4">
            <a
                title="{{ $page->siteName }} Myabout"
                href="/myabout"
                class="block mt-0 mb-4 text-sm no-underline {{ $page->isActive('/myabout') ? 'active text-blue-500' : 'text-gray-800 hover:text-blue-500' }}"
            >Myself</a>
        </li>
        <li class="pl-4">
            <a
